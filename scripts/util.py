import time, electrum_XSH as electrum, Queue
from electrum_XSH import Interface, SimpleConfig
from electrum_XSH.network import filter_protocol, parse_servers
...
def get_peers():
    ...
    q = Queue.Queue()
    interface = electrum.Interface('electrum-SHIELD.xyz:50002:s', q)
    interface.start()
    i, r = q.get()
