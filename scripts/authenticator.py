...
from electrum_XSH import SimpleConfig, Wallet, WalletStorage, format_satoshis
from electrum_XSH import util
from electrum_XSH.transaction import Transaction
from electrum_XSH.bitcoin import base_encode, base_decode
    ...
    content = """
      ...
      <LinearLayout 
        ...
        <TextView
          ...
          android:text="Electrum- XSHAuthenticator"
...
class Authenticator:
    ...
    def __init__(self):
        global wallet
        self.qr_data = None
        storage = WalletStorage('/sdcard/electrum-XSH/authenticator')
