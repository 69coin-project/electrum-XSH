...
from electrum_XSH.bitcoin import is_valid
...
import re
import time
from electrum_XSH.wallet import Wallet, WalletStorage
import webbrowser
...
from electrum_XSH.version import ELECTRUM_VERSION as electrum_version
from electrum_XSH.util import format_satoshis, age
...
class MiniWindow(QDialog):
    ...
    def __init__(self, actuator, expand_callback, config):
        ...
        self.address_input.setPlaceholderText(_("Enter a SHIELD address or contact"))
        ...
        self.setWindowTitle("Electrum-XSH")
    ...
    def the_website(self):
        webbrowser.open("https://ShieldCoin.com")
...
class ReceivePopup(QDialog):
    ...
    def setup(self, address):
        label = QLabel(_("Copied your SHIELD address to the clipboard!"))
        ...
        self.setWindowTitle("Electrum - " + _("Receive SHIELD payment"))
