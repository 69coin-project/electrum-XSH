...
from electrum_XSH import Wallet
...
from electrum_XSH.plugins import always_hook, run_hook
from electrum_XSH.mnemonic import prepare_seed

MSG_ENTER_ANYTHING    = _("Please enter a seed phrase, a master key, a list of SHIELD addresses, or a list of private keys")
...
class InstallWizard(QDialog):
    ...
    def restore_or_create(self):
        ...
        for i, (wtype,name) in enumerate(self.wallet_types):
            if not filter(lambda x:x[0]==wtype, electrum_XSH.wallet.wallet_types):
                continue
