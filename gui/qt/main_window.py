...
from electrum_XSH.bitcoin import MIN_RELAY_TX_FEE, COIN, is_valid
from electrum_XSH.plugins import run_hook
from electrum_XSH.i18n import _
from electrum_XSH.util import block_explorer, block_explorer_info, block_explorer_URL
from electrum_XSH.util import print_error, print_msg
from electrum_XSH.util import format_satoshis, format_satoshis_plain, format_time, NotEnoughFunds, StoreDict
from electrum_XSH import Transaction
from electrum_XSH import mnemonic
from electrum_XSH import util, bitcoin, commands, Wallet
from electrum_XSH import SimpleConfig, Wallet, WalletStorage
from electrum_XSH import Imported_Wallet
from electrum_XSH import paymentrequest
from electrum_XSH.contacts import Contacts
...
from electrum_XSH import ELECTRUM_VERSION
import re
...
from electrum_XSH.paymentrequest import PaymentRequest, InvoiceStore, get_payment_request
...
class ElectrumWindow(QMainWindow):
    ...
    def load_wallet(self, wallet):
        ...
        title = 'Electrum-XSH %s  -  %s' % (self.wallet.electrum_version, self.wallet.basename())
    ...
    def init_menubar(self):
        ...
        help_menu.addAction(_("&Official website"), lambda: webbrowser.open("https://ShieldCoin.com"))
    ...
    def show_about(self):
        QMessageBox.about(self, "Electrum-XSH",
            _("Version")+" %s" % (self.wallet.electrum_version) + "\n\n" + _("Electrum's focus is speed, with low resource usage and simplifying SHIELD. You do not need to perform regular backups, because your wallet can be recovered from a secret phrase that you can memorize or write on paper. Startup times are instant because it operates in conjunction with high-performance servers that handle the most complicated parts of the SHIELD system."))

    def show_report_bug(self):
        QMessageBox.information(self, "Electrum-XSH - " + _("Reporting Bugs"),
            _("Please report any bugs as issues on github:")+" <a href=\"https://github.com/ShieldCoin/electrum-XSH/issues\">https://github.com/ShieldCoin/electrum-XSH/issues</a>")
    ...
    def read_send_tab(self):
        ...
        for _type, addr, amount in outputs:
            if addr is None:
                QMessageBox.warning(self, _('Error'), _('SHIELD Address is None'), _('OK'))
                return
            if _type == 'address' and not bitcoin.is_address(addr):
                QMessageBox.warning(self, _('Error'), _('Invalid SHIELD Address'), _('OK'))
                return
            if amount is None:
    ...
    def pay_to_URI(self, URI):
        ...
        try:
            ...
            QMessageBox.warning(self, _('Error'), _('Invalid SHIELD URI:') + '\n' + str(e), _('OK'))
            return
        self.tabs.setCurrentIndex(1)
    ...
    def new_account_dialog(self, password):
        ...
        e = QLineEdit()
        vbox.addWidget(e)
        msg = _("Note: Newly created accounts are 'pending' until they receive SHIELD coins.") + " " \
    ...
    def do_export_labels(self):
        ...
        try:
            fileName = self.getSaveFileName(_("Select file to save your labels"), 'electrum-XSH_labels.dat', "*.dat")
            if fileName:
                with open(fileName, 'w+') as f:
                    json.dump(labels, f)
    ...
    def plugins_dialog(self):
        from electrum_XSH.plugins import plugins, descriptions, is_available, loader
